          ...
          <div className="card">
            <motion.div className="card__item-dash">
              <div className="card__item">
                ...
                <h1 className="card__item-h1">Designer</h1>
              </div>
              <div className="card__item2">
                ...
                <ul className="card__item2-list">
                  {" "}
                  I LIKE TO DESIGN
                  <li className="card__item2-list-item">Web Design</li>
                  <li className="card__item2-list-item">Mobile Apps</li>
                </ul>
                <ul className="card__item2-list">
                  {" "}
                  TOOLS
                  <li className="card__item2-list-item">Figma</li>
                </ul>
              </div>
            </motion.div>
              ...
              <div className="card__item2">
                ...
                <ul className="card__item2-list">
                  ...
                  <li className="card__item2-list-item">
                    Html, Css, Js, React, Redux, Sass, Framer motion, Firebase
                    etc.
                  </li>
                </ul>
                <ul className="card__item2-list">
